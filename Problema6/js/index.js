...
console.log(`Primer intento: ${esPalindromo("Dabale arroz a la zorra el abad")} \nSegundo intento: ${esPalindromo("SOMOS o no somos")}\nTercer intento: ${esPalindromo("soluciones")}  \nCuarto intento: ${esPalindromo("ana ana")}`);
